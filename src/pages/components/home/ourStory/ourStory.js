    ...
    <section className={styles.container}  data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
      <div className={styles.content} data-aos="fade-in" data-aos-delay="600" data-aos-duration="1000">
        ...
        <p>
          ...
          <br />
          <br /> ומזה מספר שנים המטפלת הרשמית בעור הפנים של מלכות היופי ומועמדות לתחרות מלכת היופי. את הקליניקה לאסתטיקה
          מתקדמת הקמתי לפני שנים רבות, מתוך החזון לאפשר לכל אחת ללכת עם גב זקוף ופנים קורנות, לאהוב את מי שהיא, ואת מה
          שהיא רואה במראה. <br />
